...
export const loadsTable = pgTable("loads", {
  ...
  puReminderSentAt: timestamp("pu_reminder_sent_at", { withTimezone: true }),
  delReminderSentAt: timestamp("del_reminder_sent_at", { withTimezone: true }),
  ...
  statusBoardOnly: boolean("status_board_only").notNull().default(false),
